        ...
        <BannerHeading>
            <div className="container">
                <Headingwrapper>
                    ...
                    <Button>Apply
                        <Image src={WhiteArrow}alt='' /> </Button>


                    <div className="icons">
                        <Link href="/" passHref>
                        <svg fill="#3C5B9A" viewBox="0 0 24 24" width="22px" height="22px">
                            <path
                        ...
                        <Link href="/" passHref>
                        <svg fill="#000000" viewBox="0 0 24 24" width="22px" height="22px">
                            <path
                        ...
                        <Link href="/" passHref>
                        <svg fill="#000000" viewBox="0 0 48 48" width="22px" height="22px">
                            <path
