...
import { LastSection } from './Footer.styles'
import Footerlogo from '../../assets/images/footerlogo.png'
import { FooterLogo } from './Footer.styles'
import Image from 'next/image'
import { ContentWrapper } from './Footer.styles'
import { SocialMedia } from './Footer.styles'
export const ChaseDreams = ()=>{
    return(
    ...
    return (<>
        ...
        <StyledFooter>
            <div className="container">
                <ContentWrapper>
                    <div className="col-1">
                        <FooterLogo><Image src={Footerlogo}alt='logo'/></FooterLogo>
                        <p>Concord Royal Court (3rd floor) <br />
Dhanmondi, Dhaka 1209, <br /> Bangladesh.</p>
                        <span>© 2020 Executive Trade International.</span>
                    </div>
                    <div className="col-2">
                        <li>About Us</li>
